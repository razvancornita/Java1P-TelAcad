...
public class TransactionPlay {
    ...
    public boolean e5_areTradersInMilan(List<Transaction> transactions) { return false; }

    // TODO: returns the sum of all the transactions from Traders that are from Cambridge
    public int e6_getSumOfValuesOfTransactionsFromCambridgeTraders(List<Transaction> transactions) { return 0; }
